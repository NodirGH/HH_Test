...
class FavoriteCoursesAdapter() : RecyclerView.Adapter<FavoriteCoursesAdapter.FavoriteCoursesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoriteCoursesViewHolder {
        return FavoriteCoursesViewHolder(
    ...
    inner class FavoriteCoursesViewHolder(private val binding: ItemCourseBinding) :
